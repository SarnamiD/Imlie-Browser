...
To build it, it is needed to clone the "Imlie Addon Framework Library":https://github.com/Anasthase/ImlieAddonFrameworkLibrary project.

h1. Writting addons

See "ImlieSampleAddon":https://github.com/Anasthase/TintBrowserSampleAddon .

h1. How to translate Imlie in your language

Before starting a translation, you must agree that your work will be released under the same license as Imlie, e.g. "GPL version 3":http://www.gnu.org/licenses/gpl-3.0.en.html. Also do not forget that a software translation is not a one-shot work, and that new translations may be needed after your initial work.
...
"https://raw.github.com/Anasthase/Imlie/master/res/values/strings.xml":https://raw.github.com/Anasthase/TintBrowser/master/res/values/strings.xml
...
Either send me an e-mail, with your modified file and the language you translated, or open an "issue":https://github.com/Anasthase/Imlie/issues and post your file there. 
